...
within Room_070511.uka_070511;
model uka_070511
  "This is the simulation model of uka_070511 with traceable ID 0"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    internalGainsMode = 1,
    zoneParam = {
      uka_070511_DataBase.uka_070511_UKA_070511()
      },
  heatAHU=true,
  coolAHU=true,
  dehuAHU=false,
  ...
  AixLib.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam=
      "C:/Users/Jonas/Py/TEASER_070511/teaser/data/input/inputdata/weatherdata/RealData_TRY_mix_2020010100_2020071703.mos")
    "Weather data reader"
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Room_070511/uka_070511/InternalGains_uka_070511.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Room_070511/uka_070511/AHU_uka_070511.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Room_070511/uka_070511/TsetHeat_uka_070511.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://Room_070511/uka_070511/TsetCool_uka_070511.txt"),
      columns=2:2)
